              ...
              <div key={index}>
                <Link href={work.url} className="block hover:opacity-80 transition-opacity duration-200 work-link">
                  <div className="flex justify-between items-baseline mb-1">
                    <h3 className="text-gray-900 font-medium text-sm">{work.title}</h3>
                    <span className="text-xs text-gray-500 font-medium ml-4">{work.year}</span>
                  </div>
                  <div className="text-xs text-gray-600 mb-3">{work.techStack}</div>

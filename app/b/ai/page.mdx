...
import { Tokenization, SelfAttention, NeuralNetwork, ContextAwareResponse, Transformer } from '@/app/components/layout/csr';
...
<AnimatedName />
<BlogViewCounter slug="/b/ai" createdAt={new Date('2024-11-29')} />
